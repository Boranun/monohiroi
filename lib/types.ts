...
export const ENEMIES: Enemy[] = [
  ...
  { id: 'birthday-boy', name: 'Birthday Boy', nameJp: 'バースデーボーイ', weight: 4, hp: 150, orbValue: '$2,200~$2,900', canCarry: true, icon: '/enemies/Monohiroi-Birthday_Boy.png' },
  { id: 'cleanup-crew', name: 'Cleanup Crew', nameJp: 'クリーンアップクルー', weight: 4, hp: 150, orbValue: '$2,200~$2,900', canCarry: true , icon: '/enemies/Monohiroi-Cleanup_Crew.png'},
  ...
  { id: 'loom', name: 'Loom', nameJp: 'ルーム', weight: 13, hp: 500, orbValue: '$5,500~$7,500', canCarry: true, icon: '/enemies/Monohiroi-Loom.png' },
  { id: 'oogly', name: 'Oogly', nameJp: 'ウーグリー', weight: 9, hp: 200, orbValue: '$3,500~$4,500', canCarry: true , icon: '/enemies/Monohiroi-Oogly.png'},
  ...
  { id: 'apex-predator', name: 'Apex Predator', nameJp: 'エイペックスプレデター', weight: 4, hp: 150, orbValue: '$2,000~$4,300', canCarry: true , icon: '/enemies/Monohiroi-Apex_Predator.png'},
  ...
  { id: 'hidden', name: 'Hidden', nameJp: 'ヒドゥン', weight: 4, hp: 100, orbValue: '$3,500~$7,000', canCarry: true, icon: '/enemies/Monohiroi-Hidden.png' },
  ...
  { id: 'mentalist', name: 'Mentalist', nameJp: 'メンタリスト', weight: 4, hp: 150, orbValue: '$3,000~$6,000', canCarry: true , icon: '/enemies/Monohiroi-Mentalist.png'},
  { id: 'peeper', name: 'Peeper', nameJp: 'ピーパー', weight: 999, hp: 30, orbValue: '$2,000~$4,000', canCarry: false, icon: '/enemies/Monohiroi-Peeper.png' },
  { id: 'reaper', name: 'Reaper', nameJp: 'リーパー', weight: 9, hp: 250, orbValue: '$6,000~$8,000', canCarry: true , icon: '/enemies/Monohiroi-Reaper.png'},
  ...
  { id: 'spewer', name: 'Spewer', nameJp: 'スピュワー', weight: 4, hp: 65, orbValue: '$1,000~$4,000', canCarry: true , icon: '/enemies/Monohiroi-Spewer.png'},
  { id: 'trudge', name: 'Trudge', nameJp: 'トラッジ', weight: 13, hp: 500, orbValue: '$5,000~$8,000', canCarry: true , icon: '/enemies/Monohiroi-Trudge.png'},
